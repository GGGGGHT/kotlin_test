...
val countMStudent1 = students.count { it?.sex == "m" }

val scoreTotal = students.sumOf { it?.score ?: 0 }

val sum = students.fold(0) { accumulator, student -> (accumulator + (student?.score ?: 0)) }